...
### Fix — WB1 быстрее при меньшей очереди
- Стартовая полоса поднята до 32 Мбит/с; дальнейший разгон разрешён только при устойчиво низком ACK RTT.
- Убрано ложное восстановление скорости по быстрому `WriteSample`, carrier-очередь ограничена 0,5 МБ.
