    ...
    <>
      ...
      <div className="as-overlay" onClick={onClose}>
        <div className="as-modal" onClick={e => e.stopPropagation()}>
          ...
          <input className="as-input" placeholder="Пароль туннеля" type="password" value={password} onChange={e => setPassword(e.target.value)} onPaste={e => void handleControlledPaste(e, password, setPassword)} />
          <input
            className="as-input"
